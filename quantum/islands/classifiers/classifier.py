...
from quantum.islands.features.features import QuantumFeatureSet
from quantum.islands.features.features_v2 import QuantumFeatureSetV2
from quantum.islands.gates.gates import (
    hadamard_gate,
    rotate_y_gate,
    rotate_z_gate,
    get_probabilities,
        ...
        for feature_name, feature in quantum_feature_set.features.items():
            ...
            if importance > 0 and p_contrib > 0:
                ...
                if hasattr(feature, 'value'):
                    ...
                    from quantum.islands.gates.gates import phase_shift_gate
