...
from quantum.hierarchical.examples.ramsey_number_solver import RamseyGraph, RamseySolver
...
def demo_small_problem():
    ...
    print(f"  python quantum/hierarchical/examples/ramsey_number_solver.py --n 45 --k 5")
