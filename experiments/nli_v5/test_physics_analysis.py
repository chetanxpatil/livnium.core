...
def test_debug_mode_accuracy():
    ...
    debug_file = 'experiments/nli_v5/patterns_canonical.json'
...
def test_contradiction_divergence():
    ...
    normal_file = 'experiments/nli_v5/patterns_fixed.json'
...
def test_phase_diagram():
    ...
    canonical_file = 'experiments/nli_v5/physics_fingerprints.json'
